        ...
        var KEY0 = 48,
            ...
            createDateTimePicker = function( input ) {
                ...
                var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+(options.weeks?' xdsoft_showweeks':'')+options.className+'"></div>'),
                    ...
                    mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span></div><div class="xdsoft_label xdsoft_year"><span></span></div><button type="button" class="xdsoft_year_prev"></button><button type="button" class="xdsoft_year_next"></button><button type="button" class="xdsoft_next"></button></div>'),
                            ...
                            var table     =    '',
                                ...
                                while( i<_xdsoft_datetime.currentTime.countDaysInMonth()||start.getDay()!=options.dayOfWeekStart||_xdsoft_datetime.currentTime.getMonth()==start.getMonth() ) {
                                    ...
                                    if(newRow) {
                                        ...
                                        if(options.weeks) {
                                            table+='<th class="xdsoft_week xdsoft_week'+start.getDay()+' '+ classes.join(' ')+'">'+w+'</th>';
                                        }
                                    }
